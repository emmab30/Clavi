        ...
        {this.state.selectState === 'monthAndDate' && (
          <View style={styles.calendar}>
            <View style={styles.headActionContainer}>
              <TouchableOpacity style={{ paddingHorizontal: 10 }} onPress={this.previousMonth}>
                <Text
                  style={{
                    paddingHorizontal: 0,
                    fontSize: 15,
              ...
              <Text style={{fontSize: 15, fontFamily: Utils.Font.Montserrat(800), color: 'black', fontWeight: 'bold'}}>
                {this.state.focusedMonth.format('MMMM YYYY')}
              </Text>
              <TouchableOpacity style={{ paddingHorizontal: 10 }} onPress={this.nextMonth}>
                <Text
                  style={{
                    paddingHorizontal: 0,
                    fontSize: 15,
